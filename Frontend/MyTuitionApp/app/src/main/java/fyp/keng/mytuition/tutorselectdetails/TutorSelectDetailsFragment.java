...
import fyp.keng.mytuition.reservecalendar.ReserveCalendarActivity;
...
public class TutorSelectDetailsFragment extends Fragment implements  TutorSelectDetailsContract.View {
    ...
    public static String TUTOR_ID = "fyp.keng.mytuition.TUTOR_ID";
    public static String TUTOR_PRICE = "fyp.keng.mytuition.TUTOR_PRICE";
    public static String ALREADY_PAIRED = "fyp.keng.mytuition.ALREADY_PAIRED";
    ...
    public void setTutor(User user) {
        ...
        if (presenter.alreadyPairedWith(user)) {
            paired = true;
            chooseTutor.setVisibility(View.GONE);
            tutorChosen.setVisibility(View.GONE);
        }

        Picasso.with(getContext()).load(user.getAvatar()).into(userImage);
        userName.setText(user.getFirstName() + " " + user.getLastName());
        userDescription.setText(user.getDescription());
        tutorPrice.setText("RM"+user.getPrice());
    }
