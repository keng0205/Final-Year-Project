package fyp.keng.mytuition.data.source.local;
...
import fyp.keng.mytuition.data.entities.events.LatestMessagesChangedEvent;
import fyp.keng.mytuition.data.source.MyTuitionDataSource;
import okhttp3.MultipartBody;
import retrofit2.Callback;
import retrofit2.Response;

public class MyTuitionLocalDataSource implements MyTuitionDataSource {
    private static MyTuitionLocalDataSource instance;
    ...
    public MyTuitionLocalDataSource(Context context) {
    ...
    public static MyTuitionLocalDataSource getInstance(Context context) {
        if (instance == null) {
            instance = new MyTuitionLocalDataSource(context);
        }
