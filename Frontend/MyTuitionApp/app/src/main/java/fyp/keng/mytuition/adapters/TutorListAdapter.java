package fyp.keng.mytuition.adapters;
...
//https://s3.eu-central-1.amazonaws.com/tuteepics/avatars/OaY1mMNkWdPcSoJngTBNL3Ae08gh6Fsw3g5PbirZoMCvPPPLHInIv8qAk0eUYfTN.jpg
        Picasso.with(context).load(user.getAvatar()).into(profilePicture);
